...
void main() {
    ...
    vec2 wavedUv2 = vec2(vUv.x + sin(vUv.y * 30.0) * 0.1, vUv.y + sin(vUv.x * 30.0) * 0.1);
    vec2 wavedUv3 = vec2(vUv.x + sin(vUv.y * 100.0) * 0.1, vUv.y + sin(vUv.x * 100.0) * 0.1);
    ...
    // // pattern 37
    // float strength = 1.0 - step(0.01, abs(distance(wavedUv2, vec2(0.5)) - 0.25));
    // gl_FragColor = vec4(vec3(strength), 1.0);

    // // pattern 38
    // float strength = 1.0 - step(0.01, abs(distance(wavedUv3, vec2(0.5)) - 0.25));
    // gl_FragColor = vec4(vec3(strength), 1.0);
    ...
    // // pattern 44
    // float angle = atan(vUv.x - 0.5, vUv.y - 0.5) / (PI * 3.183) + 0.5;
